...
int main(void)
{
    ...
    int height, row, hash, space, right_hash;
    do
    {
    ...
    for (row = 0; row < height; row++)
    {
        ...
        for (hash = 0; hash < row + 1; hash++)
        {
            ...
            // This adds a "gap" in between adjacent pyramids
            printf("  ");
        // This prints the second hashes
        for (right_hash = 0; right_hash < row + 1; right_hash++ )
        {
            printf("#");
        }
        printf("\n");
